...
def cb_admin_check(func: Callable) -> Callable:
    async def decorator(client, cb):
        ...
        if cb.from_user.id in admemes:
            ...
            await cb.answer("💡 ꜱᴀᴅᴇᴄᴇ ʏᴏɴᴇᴛɪᴄɪ ʙᴜ ᴅᴜɢᴍᴇʏᴇ ᴅᴏᴋᴜɴᴀʙɪʟɪʀ !", show_alert=True)
            return
...
@Client.on_message(
    command(["playlst", f"playlist@{BOT_USERNAME}"]) & filters.group & ~filters.edited
)
...
async def ytplay(_, message: Message):
    ...
    if message.chat.id in DISABLED_GROUPS:
        return
    lel = await message.reply("**ꜱᴀʀᴋɪʏɪ ᴄᴀʟᴍᴀᴍ ɪᴄɪɴ 💫🥺 ʙɪʀ ꜱᴀɴɪʏᴇ ʙᴇᴋʟᴇ. ❤️✨♩**")
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        "💡 **ʙᴇɴɪ ᴋᴜʟʟᴀɴᴍᴀᴋ ɪᴄɪɴ ʏᴏɴᴇᴛɪᴄɪ ᴏʟᴍᴀᴍ ɢᴇʀᴇᴋɪʏᴏʀ.** ᴠᴇʀɪʟɪᴄᴇᴋ ɪᴢɪɴʟᴇʀ:\n\n» ❌ __ᴍᴇꜱᴀᴊʟᴀʀɪ ꜱɪʟ__\n» ❌ __ᴋᴜʟʟᴀɴɪᴄɪ ᴇᴋʟᴇ__\n» ❌ __ꜱᴇꜱʟɪ ꜱᴏʜʙᴇᴛ ʏᴏɴᴇᴛᴍᴇ__\n\n**ꜱᴏɴʀᴀ ꜱᴜɴᴜ ʏᴀᴢɪɴ /reload**",
                    )
                    return
                try:
                    await USER.join_chat(invitelink)
                    await lel.edit(
                        f"✅ **ᴀꜱɪꜱᴛᴀɴ ʙᴀꜱᴀʀɪʏʟᴀ ꜱᴏʜʙᴇᴛᴇ ɢɪʀᴅɪ**",
                    )
                    ...
                    # print(e)
                    await lel.edit(
                        f"🔴 **ʙᴇᴋʟᴇᴍᴇ ʜᴀᴛᴀꜱɪ** 🔴 \n\n**ᴀꜱɪꜱᴛᴀɴ ɪᴄɪɴ ʙɪʀᴄᴏᴋ ʙɪʀʟᴇꜱᴛɪʀᴍᴇ ɪꜱᴛᴇɢɪ ɴᴇᴅᴇɴɪʏʟᴇ ʙᴜ ɢʀᴜʙᴀ ᴋᴀᴛɪʟᴀᴍᴀᴅɪ.**"
                        f"\n\n**ᴠᴇʏᴀ @{ASSISTANT_NAME} ʙᴜ ɢʀᴜʙᴀ ᴋᴇɴᴅɪɴɪᴢ ᴛᴇᴋʀᴀʀ ᴇᴋʟᴇʏɪɴ.**",
                    )
    ...
    for i in message.command[1:]:
        query += " " + str(i)
    print(query)
    await lel.edit("💙 **ꜱᴀʀᴋɪʏɪ ᴄᴀʟᴍᴀᴍ ɪᴄɪɴ 💫🥺 ʙɪʀ ꜱᴀɴɪʏᴇ ʙᴇᴋʟᴇ...**")
    ...
    try:
        ...
        if (dur / 60) > DURATION_LIMIT:
            await lel.edit(
                f"❌ **ꜱᴜʀᴇ** `{DURATION_LIMIT}` **ᴅᴀᴋɪᴋᴀᴅᴀɴ ꜰᴀᴢʟᴀ ᴏʟᴀɴ ᴍᴜᴢɪᴋ ᴄᴀʟᴀᴍᴀᴢ !**"
            )
            return
    except:
        pass
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"💡 **ꜱɪʀᴀʏᴀ ᴇᴋʟᴇɴᴇɴ ᴘᴀʀᴄᴀ »** `{position}`\n\n🏷 **ɪꜱɪᴍ:** [{title[:35]}...]({url})\n⏱ **ꜱᴜʀᴇ:** `{duration}`\n🎧 **ᴛᴀʟᴇᴘ ᴇᴅᴇɴ:** {message.from_user.mention}",
        ...
        try:
            ...
            await lel.edit(
                "😕 **ꜱᴇꜱʟɪ ꜱᴏʜʙᴇᴛ ʙᴜʟᴜɴᴀᴍᴀᴅɪ**\n\n» ʟᴜᴛꜰᴇɴ ᴏɴᴄᴇ ꜱᴇꜱʟɪ ꜱᴏʜʙᴇᴛɪ ᴀᴄɪɴ"
            )
            return
        await lel.delete()
        await message.reply_photo(
            photo="final.png",
            caption=f"🏷 **ɪꜱɪᴍ:** [{title[:70]}]({url})\n⏱ **ꜱᴜʀᴇ:** `{duration}`\n💡 **ᴅᴜʀᴜᴍ:** `ᴏʏɴᴀᴛɪʟɪʏᴏʀ`\n"
            + f"🎧 **ᴛᴀʟᴇᴘ ᴇᴅᴇɴ:** {message.from_user.mention}",
            reply_markup=keyboard,
        )
        os.remove("final.png")
